                        ...
                        <Row form>
                            <Col md={4}>
                                <FormGroup>
                                    ...
                                    <Input required type="text" name="name" id="name" placeholder="Name"
                                        value={this.state.name} onBlur={this.handleBlur('name')} onChange={this.handleInputChange}
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    value={this.state.gender} onBlur={this.handleBlur('gender')} onChange={this.handleInputChange}
                            ...
                            <Col md={4}>
                                <FormGroup>
                                    ...
                                    value={this.state.type} onBlur={this.handleBlur('type')} onChange={this.handleInputChange}
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input required type="date" name="joinDate"  id="joiningdate" placeholder="Joining Date" 
                                        value={this.state.joinDate} onBlur={this.handleBlur('joinDate')} onChange={this.handleInputChange}
                            ...
                            <Col md={4}>
                                <FormGroup>
                                    ...
                                    <Input required type="textarea" name="address" id="address"
                                     placeholder="Address" rows="1" value={this.state.address} onBlur={this.handleBlur('address')} onChange={this.handleInputChange}
