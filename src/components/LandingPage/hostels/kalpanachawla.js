...
import building from '../img/kalpana_building.jpeg'
import mess from '../img/kalpana_mess.jpeg'
import commonroom from '../img/kalpana_commonroom.jpeg'

class KalpanaChawla extends Component {
    constructor(props){
        super(props);
    }
        ...
        return (
            <div>
                <div className="container">
                    <h1 className="hostel-heading">Kalpana Chawla Hostel</h1>
                </div>
                <div className="container">
